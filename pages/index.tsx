      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center py-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-12 max-w-2xl mx-auto">
            AI-powered assistant that generates professional User stories, action items, and edge cases from your request notes
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-12">
            <div className="relative group">
              ...
              <div className="relative bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 backdrop-blur-sm">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-gray-100">Professional Requirements</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Generate comprehensive User stories from your notes
                </p>
              </div>
            </div>
            <div className="relative group">
              ...
              <div className="relative bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 backdrop-blur-sm">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Clear next steps and follow-up actions for every Business request
                </p>
              </div>
            </div>
            <div className="relative group">
              ...
              <div className="relative bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 backdrop-blur-sm">
                <div className="text-3xl mb-4">🎯</div>
                <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-gray-100">User Stories</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Draft clear, user stories for non-tech stakeholders and tech teams automatically
                </p>
              </div>
            </div>
          </div>
          ...
          <SignedIn>
            <Link href="/product">
              <button className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-4 px-8 rounded-xl text-lg transition-all transform hover:scale-105">
                Open Business Requirement Assistant
              </button>
            </Link>
          </SignedIn>
        </div>
